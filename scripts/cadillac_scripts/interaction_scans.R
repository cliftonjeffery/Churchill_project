...
allscan1.add=scan1(qtl2apr, pp, k, covar, cores=8)

print("intsex")

allscan1.intsex=scan1(qtl2apr, pp, k, covar[,2:4], intcovar = covar[,1], cores=3)

print("intdiet")

allscan1.intdiet=scan1(qtl2apr, pp, k, covar[,c(1,3:4)], intcovar = covar[,2], cores=3)
